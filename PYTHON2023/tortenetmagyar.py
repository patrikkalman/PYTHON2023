tortenet=[
 ...
 [
    ...
    [
        ...
        ["felhívod a cigány haverod", "felhívod a kedves édesanyádat","felhívod Gáspár Lacit","Felhívod Mc Isti BOSS-t"],#választható cselekvése
        [14,15,16,17] #cselekvés sorszáma, hova ugorjon
    ],
    [
    ...
    [
        15,  #történetszál sorszáma
        " ============================================================ \n felveszi a telefont és elküld a f*szba\n ============================================================",#történetszál
        ["vissza"],#választható cselekvése
        [13] #cselekvés sorszáma, hova ugorjon
    ],
       [
        16,  #történetszál sorszáma
        " ============================================================ \n Megérkezik a Lambóval,meglátják és lecsukják adócsalásért\n ============================================================",#történetszál
        ["vissza"],#választható cselekvése
        [13] #cselekvés sorszáma, hova ugorjon
    ],
    [
        17,  #történetszál sorszáma
        " ============================================================ \n Kifizeti az óvadékot, és szabad vagy, de azert reppel neked egy jot haza fele\n ============================================================",#történetszál
        ["KILÉPÉS"],#választható cselekvése
        [18] #cselekvés sorszáma, hova ugorjon
    ],
    [
        18,  #történetszál sorszáma
        " ============================================================ \n KÖSZÖNJUK A JÁTÉKOT!\n ============================================================",#történetszál
        ],
    ]
