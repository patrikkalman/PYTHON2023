...
#canvas.create_line(0,0,500,300, fill="green", width=5)
for i in range(70):
    canvas.create_line(10*i,0,10*i,30, fill="blue", width=1)

#canvas.create_line(100,100,500,100, fill="green", width=5)
#canvas.create_line(500,100,500,500, fill="green", width=5)
#canvas.create_line(500,500,100,500, fill="green", width=5)
#canvas.create_line(100,500,100,100, fill="green", width=5)
